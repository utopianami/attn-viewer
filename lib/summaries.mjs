...
// schema=true면 --output-schema로 {type, summary} JSON을 강제한다.
export function runCodexSummary(prompt, { timeoutMs = 120_000, schema = false } = {}) {
  return new Promise((resolve, reject) => {
    ...
    if (schema) {
      args.push("--output-schema", ANALYSIS_SCHEMA_PATH);
    }
